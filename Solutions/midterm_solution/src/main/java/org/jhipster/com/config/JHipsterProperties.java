...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "Midterm@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "Midterm API";

        private String description = "Midterm API documentation";
